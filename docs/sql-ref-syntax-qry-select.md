...
* **SKYLINE OF**
     ...
     part of the skyline (DIFF). Optionally, DISTINCT can be specified to remove duplicates. In case of distinct, beware
     that the selection of which element is chosen may be completely random.
